...
[role="incremental scatter"]
* *Especifica* partes proceso desarrollo
...
aceleran el proceso de desarrollo debido especifica y define muchos de 
...
TODO: es importante poner enfasis en los problemas que presenta trabajar de cierta manera con fw independientes y que es lo que aporta una herramienta de desarrollo
...
TODO: Más ventajas respecto a fws independientes

Dar la vision de que trabajar un una herramienta de desarrollo es un nivel
superior, que te permite trabajar de forma organizada y controlada con este tipo de fw
...
Funcionalidad estrella que veremos a fondo más adelante.

*Monitorización rendimiento en producción*

TODO

TODO También será necesario responder a esto de: "El NIX está verde, cuantos
proyectos de NIX hay?

Ahí se podrá responder:

- Bueno, realmente lo del NIX está verde, sería decir que Spring, que
Jquery, que Hibernate está verde, pues como hemos visto NIX no es un FW
sino una herramienta de desarrollo que surge para solventar el problema
...
TODO: Más allá de Maven: donde nos presentaban que ellos tenían una forma de
trabajar muy ordenada que les permitía focalizar en la lógica de negocio.
