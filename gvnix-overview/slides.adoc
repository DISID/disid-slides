...
Una vez tenemos el análisis del modelo de entidades, se 
...
o en términos de base de datos quien y cuándo modifica una registro
...
*Generación de pantallas con diseño adaptativo y accesibles*
...
edición y borrado múltiple, conjunto predefinido de filtros simples, 
...
Crear patrones de visualización sobre entidades y sus relaciones: permitiendo
cualquier combinación [maestro-tabular | maestro-registro] con
...
* Mostrar en el mapa registros seleccionados
