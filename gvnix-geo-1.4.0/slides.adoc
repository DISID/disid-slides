...
* Permite mostrar y filtrar todos los datos geográficos como capas en el geoportal.
...
* Cada uno de los datos geográficos que muestra el geoportal pueden ser activados por capas.
...
Las próximas versiones incluirán las siguientes funcionalidades:
